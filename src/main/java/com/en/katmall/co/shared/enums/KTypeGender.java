...
public enum KTypeGender {
     ...
     */
    public static Optional<KTypeGender> fromCode(String code) {
     ...
     */
    public static KTypeGender fromCodeOrDefault(String code, KTypeGender defaultValue) {
     ...
     * @return Optional containing the enum if found
     */
    public static Optional<KTypeGender> fromName(String name) {
